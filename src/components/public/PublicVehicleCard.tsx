  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative block rounded-2xl overflow-hidden bg-card border border-border hover:shadow-[0_8px_40px_-12px_hsl(var(--primary)/0.15)] transition-all duration-500"
      >
        {/* Image area */}
